...
V1V Creative Studio website — a cinematic, full-screen immersive website for a creative digital studio (v1v.in). Features a Three.js 3D WebGL background with procedurally generated models, GSAP + Lenis smooth scrolling, and a password-protected admin panel.
...
- **Frontend**: React 19, Vite, Three.js, @react-three/fiber, @react-three/postprocessing, Framer Motion, Lenis, TailwindCSS 4
- **Routing**: wouter
...
### Frontend Structure
- `pages/Home.tsx` — Main page with fixed 3D canvas + scrolling HTML overlay
- `pages/Admin.tsx` — Password-protected admin dashboard (projects CRUD, settings)
- `components/canvas/Scene.tsx` — Three.js R3F canvas with post-processing (bloom, chromatic aberration, vignette)
- `components/canvas/HeroScene.tsx` — Main 3D composition (glass torus, ribbon sculpture, particles)
...
- `components/UIOverlay.tsx` — All HTML sections (hero, about, work, lab, contact)
